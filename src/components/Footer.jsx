...
//     fetch("https://api.github.com/repos/maaqiie/my-portfolio")
//       .then((res) => res.json())
//       .then((json) => {
...
//       <a className="footer-link" href="https://github.com/maqiie/my-portfolio">
//         <span>
//           <AiOutlineStar /> {gitHubInfo.stars} <BiGitRepoForked />
//           {gitHubInfo.forks} - Give this project a star!
//         </span>
//         <p>
//           <span>▷</span> Designed and built by Markpaul Mwenda &copy; {currentYear}
//         </p>

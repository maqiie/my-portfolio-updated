...
const SocialIcons = () => {
  ...
  return (
    <div className="socialIcons" style={styles.socialIcons}>
      <a className="icon" style={styles.icon} href="https://github.com/maqiie">
        {/* GitHub Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.linkedin.com/in/markpaul-muthaura-243055209/">
        {/* LinkedIn Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.instagram.com/muthaura_jr">
        {/* Instagram Icon */}
        <motion.i
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
      ...
      <a className="icon" style={styles.icon} href="https://twitter.com/muthaura_jr">
        {/* Twitter Icon */}
        <motion.i
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
